...
%s = %s;
eval %s(%s);
'''%(data,func_name,func_argv,var_rev,func_argv,var_counter,var_counter,var_rev,var_counter,var_str,var_rev,var_counter,var_str,var_data,var_name,func_name,var_data)
    return f
