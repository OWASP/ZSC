...
?>'''%(data,func_name,func_argv,var_str,var_counter,func_argv,var_counter,var_counter,var_str,func_argv,var_counter,var_str,var_data,var_name,func_name,var_data)
    return f
